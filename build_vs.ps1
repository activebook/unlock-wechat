...
Write-Output "Running: cl /W4 src\main.c main.res /link /SUBSYSTEM:WINDOWS user32.lib advapi32.lib kernel32.lib /OUT:UnlockWeChat.exe"
# link explicitly against required libraries to resolve API symbols
cl /W4 src\main.c main.res /link /SUBSYSTEM:WINDOWS user32.lib advapi32.lib kernel32.lib /OUT:UnlockWeChat.exe
